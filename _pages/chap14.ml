...
| application
| Used to add new entry points to SuiteCRM. See the chapter on [[#chap07.xhtml#entry-point-chapter|Entry Points]].
|-
| Extensions
| extensions.ext.php
| application
...
|-
| Language
| N/A<sup>[[#chap13.xhtml#fn-langNote|1]]</sup>
|  
| Used to add, update or delete language strings for both modules and app strings. See the chapter on [[#chap08.xhtml#language-chapter|Language Strings]].
|-
| Layoutdefs
| layoutdefs.ext.php
|  
...
| logichooks.ext.php
|  
| Used to add, update or delete logic hooks. See the chapter on [[#chap11.xhtml#logic-hooks-chapter|Logic Hooks]].
|-
| Include
| modules.ext.php
| application
...
| Schedulers
| Used to add new scheduled tasks. See the chapter on [[#chap12.xhtml#scheduled-tasks-chapter|Scheduled Tasks]].
|-
| UserPage
| userpage.ext.php
| Users
...
| vardefs.ext.php
|  
| Used to add, update or delete vardefs for a module. See the section on [[#chap03.xhtml#vardefs-chapter|Vardefs]].
|-
| JSGroupings
| jsgroups.ext.php
|  
