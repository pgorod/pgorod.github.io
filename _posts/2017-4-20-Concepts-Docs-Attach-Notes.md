...
In other posts, I explain how [Documents]({{ site.baseurl }}{% post_url 2017-4-19-How-are-Documents-Stored %}) and [Attachments]({{ site.baseurl }}{% post_url 2017-4-21-How-are-Attachments-Stored %}) are stored in the database and in the file system.